...
public record FixedDepositDTO (String id , @NotNull  BigDecimal amount, @NotNull String accountNumber, @NotNull String institutionName,
                               ...
                               @NotNull LocalDate closeDate, String nomineeName, @NotNull String compoundingFrequency,
                               BigDecimal maturityAmount, BigDecimal currentAmount, Double taxPercent) { }
